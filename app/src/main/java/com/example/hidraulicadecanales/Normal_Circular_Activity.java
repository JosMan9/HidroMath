...
public class Normal_Circular_Activity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private Fragment opciones;
    private BottomNavigationView navegacion;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_normal__circular_);
        ...
        navegacion = (BottomNavigationView)findViewById(R.id.navigationCirculo);
        opciones = new OpcionesCircular();
        establecerFragmento(opciones,R.id.frameLayoutCircular);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.calculo_navegador:
                        establecerFragmento(new OpcionesCircular(), R.id.frameLayoutCircular);
                        return true;
                    case R.id.tablas_navegador:
                        establecerFragmento(new TablaFragment(), R.id.frameLayoutCircular);
                        return true;
                    case R.id.nomenclatura_navegador:
                        establecerFragmento(new FormulaCirculoFragment(), R.id.frameLayoutCircular);
                        return true;
                }
                return false;
            }

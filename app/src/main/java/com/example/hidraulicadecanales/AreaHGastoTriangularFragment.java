...
public class AreaHGastoTriangularFragment extends Fragment {
    ...
    public AreaHGastoTriangularFragment(){}
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    double area = (gastoD * numero_Manning) / ((Math.pow(radioD, (0.6667))) * Math.pow(pendienteD, 0.5));
